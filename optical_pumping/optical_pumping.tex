...
\begin{document}
  \begin{tikzpicture}[thick, font=\scriptsize, scale=1.5]
    ...
    \draw [fill=white!95!black] (4.5,0.75) rectangle (5.5,1.25);
    \draw [color=copper, very thick] (5,1) circle (0.25cm);
    ...
    % light path
    \draw [color=ruby] (0.5,1.15) -- (1.5,1.35) -- (6.5, 0.85) -- +(1,0);
    \draw [color=ruby] (0.5,0.85) -- (1.5,0.65) -- (6.5, 1.15) -- +(1,0);

    % further annotations
    \node [align=center, outer sep=-0.1cm] (Cell) at (4.7,-0.4) {\ce{Rb} absorption\\cell};
    \draw [thin] (Cell.north) -- (4.7,0.85);
