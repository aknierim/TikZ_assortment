...
\begin{document}
  \begin{tikzpicture}
    ...
    \draw[
      warmyellow,
      xshift=\globalshift
    ] (-0.65,9) -- (0.1,7.85) node[midway, above right, maincolour] {\large $\gamma$-ray entering the atmosphere};
    ...
    \node[
      ...
      right, 
      xshift=\globalshift
    ] at (5,5) {\large Pool of Cherenkov light};
    ...
    \node[
      ...
      right,
      xshift=\globalshift
    ] at (2,7) {\large Extensive Air Shower (EAS)};
    ...
    \node [
      ...
      below, 
      yshift=-1.8cm
    ] at (CAMERAFRAME) {\large Snapshot in camera frame};
