...
\begin{document}
  \begin{tikzpicture}
    ...
    \node[xshift=\globalshift+1cm] at (8,2.3) {%
      \reflectbox{\includegraphics[height=0.5cm]{subgraphics/xkcd_dark.pdf}}
    };
    ...
    % CHERENKOV RADIATION
    \node [] at (-3.4, 6.3) {%
      \includegraphics[height=3cm]{subgraphics/cherenkov_radiation_dark.pdf}
    };
    ...
    % HEITLER MODEL
    \node [] at (1, 6.3) {%
      \includegraphics[height=3cm]{subgraphics/heitler_model_dark.pdf}
    };
    ...
    \node[
      ...
      \reflectbox{\includegraphics[height=2.5cm]{subgraphics/contours_mst_light.pdf}}
    };
    \node[
      inner sep=15pt, 
      xshift=\globalshift
