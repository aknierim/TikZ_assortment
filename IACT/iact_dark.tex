...
\begin{document}
  \begin{tikzpicture}
    ...
    \node[xshift=\globalshift+1cm] at (8,2.3) {\input{xkcd_astronomer_light.tex}};
    ...
    % CHERENKOV RADIATION
    \node [] at (-2.3, 6) {\includegraphics[height=5.7cm]{build/tikz/cherenkov_radiation_dark.pdf}};
    ...
    % HEITLER MODEL
      \node [] at (-2.3, 6) {\includegraphics[height=5.7cm]{build/tikz/heitler_model_dark.pdf}};


    % TELESCOPES
    \node[inner sep=15pt, xshift=\globalshift] at (6,1.3){\reflectbox{\includegraphics[height=2.5cm]{graphics/contours_mst_light.pdf}}};
    \node[inner sep=15pt, xshift=\globalshift] at (4,1.3){\reflectbox{\includegraphics[height=2.5cm]{graphics/contours_mst_light.pdf}}};
    ...
    \node [circle, draw, color=maincolour, fill=darkmode, minimum width = 4cm, path picture = {
      \node [] at (path picture bounding box.center) {\includegraphics[height=4.4cm]{graphics/mst_camera_frame.pdf}};
